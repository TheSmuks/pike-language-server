// ---------------------------------------------------------------------------
// xml-renderer.ts: AutoDoc XML → markdown rendering
// Extracted from xmlParser.ts to reduce file size.
import type { XmlNode } from './xmlParser';
// Functions: renderType, renderSignature, renderInline, renderBlocks
// ---------------------------------------------------------------------------
